...
![Worldline Engine 分层执行架构](docs/figures/architecture.svg)
...
![Worldline Engine 记忆召回、上下文组装与审计路径](docs/figures/memory-pipeline.svg)
...
![Worldline Engine layered execution architecture](docs/figures/architecture.svg)
...
![Worldline Engine memory retrieval, context assembly, and audit path](docs/figures/memory-pipeline.svg)
